...
## 1.1 battle of the forms[格式之战，要约答复中新增条款的效力]
...
## 6.1 When disclosure is required to avoid misrepresentation
...
| Specific | Assignment of rights only | Barred |  Allowed |
| Specific | Delegation of duties only | Allowed | Barred |  
...
> Receive indirect benefit from contract even though there was no contractual intent to benefit them.
